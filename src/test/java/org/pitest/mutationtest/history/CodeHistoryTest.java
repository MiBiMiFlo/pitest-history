...
public class CodeHistoryTest {
  ...
  public void shouldReturnNoneWhenNoMatchingHistoricResultExists() {
    ...
    assertThat(this.testee.getPreviousResult(id)).isEmpty();
  }
  ...
  public void shouldReturnHistoricResultWhenOneExists() {
    ...
    assertThat(this.testee.getPreviousResult(id)).contains(expected);
  }

  @Test
  public void shouldTreatNewClassAsChanged() {
    assertThat(this.testee.hasClassChanged(ClassName.fromString("notInLastRun")))
        .isTrue();
  }
  ...
  public void shouldTreatClassesWithDifferentHashesAsChanged() {
    ...
    this.historicClassPath.put(foo, makeHistory(new HierarchicalClassId(
        currentHash + 1, foo, "0")));
    assertThat(this.testee.hasClassChanged(ClassName.fromString("foo"))).isTrue();
  }
  ...
  public void shouldTreatClassesWithModifiedParentAsChanged() {
    ...
    assertThat(this.testee.hasClassChanged(foo)).isTrue();
  }
  ...
  public void shouldTreatClassesWithSameHashAsUnChanged() {
    ...
    assertThat(this.testee.hasClassChanged(ClassName.fromString("foo"))).isFalse();
  }
